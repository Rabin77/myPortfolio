                    ...
                    <div className="container">
                        ...
                        <div className="col-md-8">
                            <div className=" schoolname">
                                ...
                                <li className="justify-text">+2 at Shree Himalaya Higher Secondary School, Kushma Municipality 02 Khurto</li>
                                <li className="justify-text">Information Technology at Internation School of management & technology,Kaski Pokhara </li>
                            </div>
                            </div>
